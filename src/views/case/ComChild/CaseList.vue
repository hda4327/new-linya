    ...
    <div class="list">
            <div class="item" v-for="(item,index) in caseList" :key="index">
                <div class="item-inner">
                    ...
                    <div class="user-info">
                        <div class="ll">
                            <img :src="$baseUrl+item.seller_info.img_resource.src">
                            <span>{{item.seller_info.nick_name}}</span>
                        </div>
                        <div class="rr">
                            <img src="~assets/img/case/eye.png" alt="">
    ...
    .item{
        ...
        .item-inner{
            ...
            .img{
                ...
                .tag{
                    background: linear-gradient(-60deg,rgba(138,190,247,1) 0%,rgba(101,141,245,1) 100%);
                    border-radius: 6.5px;
                    font-size: 7.5px;
                    font-weight: 400;
