<template>
    <div class="team-list">
        <router-link :to="'/teamDetail/'+item.id" class="team-item" v-for="(item, index) in teamData" :key="index">
            ...
            <div class="contract-content">
                <div class="left">
                    ...
                    <div class="wx" v-show="item.wx_img_resource" @click.stop.prevent="showModal(item.wx_img_resource)">
                        <div class="ico-bg wx-bg">
                            <img src="~assets/img/doctor/wx.png" alt="" class="wx-ico">
                        </div>
                        <span>微信</span>
                    </div>
                </div>
