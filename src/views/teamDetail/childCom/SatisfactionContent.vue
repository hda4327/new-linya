...
<script>
    ...
    export default {
        ...
        data() {
            return {
                smilingImgList:[
                    [require('@/assets/img/doctor/smiling@2x-1.png'), require('@/assets/img/doctor/smiling@2x-1-n2.png')],
                    [require('@/assets/img/doctor/smiling@2x-2.png'), require('@/assets/img/doctor/smiling@2x-2-n2.png')],
                    [require('@/assets/img/doctor/smiling@2x-3.png'), require('@/assets/img/doctor/smiling@2x-3-n2.png')],
                ],
                activeIndex: -1,
