...
<script>
    ...
    export default {
        ...
        data() {
            return {
                smilingImgList: [
                    {img:require('@/assets/img/doctor/smiling@2x-3-n2.png'), color:'rgba(255, 150, 0, 1)', tip:'很差'},
                    {img:require('@/assets/img/doctor/smiling@2x-3-n2.png'), color:'rgba(255, 150, 0, 1)', tip:'一般'},
                    {img:require('@/assets/img/doctor/smiling@2x-2-n2.png'), color:'rgba(76, 150, 255, 1)', tip:'还不错'},
                    {img:require('@/assets/img/doctor/smiling@2x-1-n2.png'), color:'rgba(0, 183, 113, 1)', tip:'很满意'},
                    {img:require('@/assets/img/doctor/smiling@2x-1-n2.png'), color:'rgba(0, 183, 113, 1)', tip:'非常满意'},
                ],
                commentList:{}
            }
        },
        ...
        methods:{
            getCommentList(){
                reqCommentList(this.$route.params.tit).then(res=>{
